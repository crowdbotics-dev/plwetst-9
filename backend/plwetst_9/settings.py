"""
Django settings for plwetst_9 project.
...
WSGI_APPLICATION = 'plwetst_9.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "plwetst_9 API",
    "DESCRIPTION": "API documentation for plwetst_9 App",
    "VERSION": "v1",
}
